...
const FiltForm: React.FC<FiltFormProps> = ({ formData, handleChange }) => {
    ...
    >
        {[
        { value: 'A', label: 'Baby', imgSrc: '/img/baby.png' },
        { value: 'B', label: 'Big Granny', imgSrc: '/img/biggranny.png' },
        { value: 'C', label: 'C2C', imgSrc: '/img/c2c.png' },
        { value: 'D', label: 'Fancy', imgSrc: '/img/fancy.png' },
        { value: 'E', label: 'Star', imgSrc: '/img/filt.png' },
        { value: 'F', label: 'Granny', imgSrc: '/img/grannyblan.png' },
        { value: 'G', label: 'Scrappy', imgSrc: '/img/scrapyblan.png' },
        ].map((filt) => (
        <label
            key={filt.value}
            className="
