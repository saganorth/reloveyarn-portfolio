                ...
                <div className="flex flex-wrap justify-center md:justify-start">
                    {['red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'violet', 'black', 'white', 'brown'].map(
                        ...
                        <div className="mb-8">
                           ...
                           <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-6 md:gap-15 lg:gap-20 px-2 justify-items-center">
                                {[
                                    { value: 'A', label: 'Tote Bag', imgSrc: '/img/tote.png' },
                                    { value: 'B', label: 'Big Bag', imgSrc: '/img/bigbag.png' },
                                    { value: 'C', label: 'Beach Bag', imgSrc: '/img/beach.png' },
                                    { value: 'D', label: 'Granny Bag', imgSrc: '/img/granny.png' },
                                    { value: 'E', label: 'Petit Bag', imgSrc: '/img/petit.png' },
                                    { value: 'F', label: 'Snus Bag', imgSrc: '/img/snus.png' },
                                ].map((bag) => (
                                    <label key={bag.value} className="flex flex-col items-end cursor-pointer transition-transform hover:scale-105 p-4">
                                        <input
                                            type="radio"
                                            name="type"
                                            value={bag.value}
